...
__all__ = [
    'SVPNormal', 'DISPID_SRIsUISupported', 'SGLexicalNoSpecialChars',
    'DISPID_SPRuleFirstElement', 'DISPID_SpeechCustomStream',
    'DISPID_SRDisplayUI', 'SPPHRASEELEMENT', 'SPTEXTSELECTIONINFO',
    'SpAudioFormat', 'DISPID_SGRId', 'DISPID_SRSSupportedLanguages',
    'SpeechRecoContextState', 'DISPID_SPRuleChildren', 'SPEI_MIN_SR',
    'DISPID_SGRSAddRuleTransition', 'SAFTGSM610_44kHzMono',
    'SSSPTRelativeToEnd', 'SAFTADPCM_8kHzStereo', 'SpWaveFormatEx',
    'DISPID_SVPriority', 'DISPID_SRGetPropertyNumber',
    'SRAInterpreter', 'DISPID_SPILanguageId', 'SITooFast',
    'SPSHORTCUTPAIR', 'SpeechWordType', 'DISPID_SPPNumberOfElements',
    'DISPID_SVWaitUntilDone', 'DISPID_SGRAttributes',
    'SGRSTTDictation', 'DISPID_SPIElements', 'SPSMF_SAPI_PROPERTIES',
    'SP_VISEME_9', 'DISPID_SRCEAudioLevel', 'SAFT22kHz8BitStereo',
    'DISPID_SOTGetAttribute', 'DISPID_SOTCSetId',
    'DISPID_SpeechPhraseAlternate', 'SPAUDIOBUFFERINFO',
    'ISpeechObjectToken', 'SPRST_ACTIVE', 'DISPID_SRCEBookmark',
    'ISpPhraseAlt', 'DISPID_SOTIsUISupported', 'SREFalseRecognition',
    'SAFT11kHz8BitMono', 'DISPID_SRCCreateResultFromMemory',
    'SSSPTRelativeToStart', 'DISPID_SOTGetDescription',
    'DISPID_SRGSetTextSelection', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SRCRetainedAudioFormat', 'ISpXMLRecoResult',
    'SPAR_Unknown', 'SPPS_RESERVED4', 'SpeechRegistryUserRoot',
    'SpeechPropertyAdaptationOn', 'SpeechRuleAttributes',
    'SpeechWordPronounceable', 'SPCS_DISABLED',
    'DISPIDSPTSI_SelectionOffset', 'SpFileStream',
    'SPSERIALIZEDPHRASE', 'SPINTERFERENCE_TOOLOUD', 'SPPROPERTYINFO',
    'DISPID_SRRSpeakAudio', 'SAFTCCITT_ALaw_11kHzMono',
    'SAFTADPCM_11kHzStereo', 'SPEI_WORD_BOUNDARY',
    'DISPID_SVSLastResult', 'SBOPause', 'ISpeechMMSysAudio',
    'ISpeechAudioBufferInfo', 'DISPID_SRCEFalseRecognition',
    'SpeechCategoryRecoProfiles', 'SGPronounciation',
    'STCLocalServer', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SVEStreamEnd', 'SPRST_INACTIVE_WITH_PURGE',
    'eLEXTYPE_USER', 'DISPID_SASState', 'SRAORetainAudio',
    'DISPID_SOTRemoveStorageFileName', 'SpInprocRecognizer',
    'ISpRecoGrammar2', 'STSF_LocalAppData', 'DISPID_SMSADeviceId',
    'DISPID_SRGDictationLoad', 'DISPID_SGRSAddSpecialTransition',
    'ISpRecoContext', 'SAFT48kHz8BitMono', 'ISpStreamFormat',
    'DISPID_SPPFirstElement', 'SPSModifier', 'SpeechGrammarWordType',
    'ISpeechRecoResult2', 'SP_VISEME_12', 'DISPID_SAFGuid',
    'SAFT24kHz8BitMono', 'DISPID_SLAddPronunciation',
    'DISPID_SPIReplacements', 'SAFT44kHz16BitMono',
    'DISPID_SpeechPhraseInfo', 'SPINTERFERENCE_TOOSLOW',
    'SPEI_REQUEST_UI', 'SPRULESTATE', 'SPEI_START_INPUT_STREAM',
    'SAFTADPCM_44kHzMono', 'DISPID_SDKCreateKey', 'DISPID_SLWWord',
    'SPSHT_NotOverriden', 'SRSEDone', 'SPEI_SR_BOOKMARK',
    'DISPID_SVAlertBoundary', 'SECNormalConfidence', 'SREBookmark',
    'SPEI_RESERVED6', 'ISpeechCustomStream', 'ISpeechFileStream',
    'DISPID_SRSCurrentStreamPosition', 'ISpeechPhraseProperty',
    'SREPrivate', 'DISPID_SGRsCount', 'DISPID_SRCPause',
    'SAFT48kHz16BitMono', 'SP_VISEME_5', 'SP_VISEME_21',
    'DISPID_SRAudioInput', 'DISPID_SPRuleName', 'SVSFPersistXML',
    'SPSNoun', 'SAFTCCITT_uLaw_11kHzMono',
    'ISpeechLexiconPronunciations', 'SASStop', 'DISPID_SGRsCommit',
    'SpeechGrammarState', 'DISPID_SBSRead',
    'DISPID_SpeechPhraseElement', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SPRsCount', 'SpMMAudioIn', 'SGRSTTEpsilon',
    'SVEWordBoundary', 'SECFDefault',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SDKSetStringValue',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SGRSTNextState',
    'SpeechTokenShellFolder', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SRCreateRecoContext', 'ISpProperties',
    'DISPID_SpeechGrammarRuleStateTransition', 'SGDSActive',
    'DISPID_SRCState', 'SPCT_COMMAND', 'DISPID_SAVolume',
    'eLEXTYPE_PRIVATE9', 'DISPID_SRCEventInterests',
    'SpTextSelectionInformation', 'DISPID_SOTsCount',
    'DISPID_SpeechPhoneConverter', 'tagSTATSTG',
    'DISPID_SGRSTransitions', 'SpeechTokenContext', 'SSTTWildcard',
    'DISPID_SRGRecoContext', 'SRESoundEnd', 'SpeechMicTraining',
    'DISPID_SRCCmdMaxAlternates', 'SP_VISEME_14',
    'DISPID_SRCESoundEnd', 'DISPID_SVAudioOutputStream',
    'SAFT12kHz16BitStereo', 'SpeechUserTraining',
    'DISPID_SDKSetBinaryValue', 'SFTSREngine', 'SVP_11', 'SITooQuiet',
    'DISPID_SVSyncronousSpeakTimeout', 'SPAS_PAUSE', 'SVSFIsXML',
    'DISPID_SVSkip', 'DISPID_SRCEEndStream', 'SpeechCategoryAudioOut',
    'DISPID_SPPConfidence', 'DISPID_SLGetPronunciations',
    'SDA_No_Trailing_Space', 'DISPID_SDKGetlongValue',
    'DISPID_SpeechPhraseProperties', 'SP_VISEME_19',
    'DISPID_SRSNumberOfActiveRules', 'SPRST_NUM_STATES',
    'DISPID_SGRSTRule', 'DISPID_SDKEnumKeys', 'DISPID_SVEWord',
    'SPEI_SR_RETAINEDAUDIO', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SLPsCount', 'SPSSuppressWord',
    'SpeechAudioFormatGUIDWave', 'DISPID_SpeechVoice',
    'ISpeechResourceLoader', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SRCRecognizer', 'SSFMOpenForRead', 'SPSTREAMFORMATTYPE',
    'SPWT_LEXICAL', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SMSGetData', 'SP_VISEME_0',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SGRsFindRule',
    'DISPID_SLGetGenerationChange', 'DISPID_SpeechPhraseElements',
    'SAFT32kHz16BitMono', 'SP_VISEME_16', 'eLEXTYPE_PRIVATE20',
    'SRATopLevel', 'SpMMAudioOut', 'SVEBookmark', 'SPAO_NONE',
    'DISPID_SVDisplayUI', 'DISPID_SRSetPropertyNumber',
    'SpeechRunState', 'SASRun', 'SAFT48kHz8BitStereo',
    'DISPID_SRRTTickCount', 'DISPID_SWFEExtraData',
    'SPEI_SR_AUDIO_LEVEL', 'SVP_14', 'ISpeechLexicon',
    'DISPID_SOTSetId', 'eLEXTYPE_PRIVATE8',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SpeechLexiconWord',
    'SREStateChange', 'SAFTNonStandardFormat',
    'DISPID_SASFreeBufferSpace', 'SPFILEMODE',
    'DISPID_SpeechGrammarRules', 'SPWORDPRONUNCIATIONLIST',
    'ISpEventSource', 'SPSHORTCUTTYPE', 'ISpGrammarBuilder',
    'DISPID_SABIBufferSize', 'SPGS_EXCLUSIVE',
    'DISPID_SRRGetXMLResult', 'SVP_0', 'SPEI_PHONEME',
    'DISPID_SpeechDataKey', 'DISPID_SRRSaveToMemory',
    'SPGRAMMARSTATE', 'tagSPTEXTSELECTIONINFO', 'eLEXTYPE_PRIVATE16',
    'SITooLoud', 'IStream', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SPCIdToPhone', 'SPRECOSTATE', 'SGRSTTWord',
    'DISPID_SVEStreamStart', 'SAFT12kHz8BitMono', 'SINone',
    'DISPID_SLPSymbolic', 'ISpResourceManager', 'SFTInput',
    'SPXRO_SML', 'DISPID_SpeechGrammarRule', 'DISPID_SPRules_NewEnum',
    'DISPID_SVGetAudioOutputs', 'DISPID_SVSVisemeId',
    'SPPHRASEREPLACEMENT', 'DISPID_SRCResume', 'SAFTADPCM_11kHzMono',
    'SpeechRecognizerState', 'SP_VISEME_20', 'DISPID_SPIStartTime',
    'ISpeechLexiconPronunciation', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SLPs_NewEnum', 'DISPID_SOTId', 'ISpeechPhraseProperties',
    'SREInterference', 'DISPID_SAFGetWaveFormatEx',
    'SpeechFormatType', 'SAFTADPCM_44kHzStereo', 'DISPID_SRIsShared',
    'SpeechDataKeyLocation', 'SAFT44kHz16BitStereo',
    'SpeechAudioFormatType', 'SpeechCategoryPhoneConverters',
    'SVSFParseSsml', 'DISPID_SPRText', 'SpeechAudioVolume',
    'DISPID_SGRName', 'SGDSInactive', 'SRTEmulated',
    'SpeechStreamSeekPositionType', 'SPSHT_OTHER',
    'SpeechCategoryAppLexicons', 'SVSFlagsAsync',
    'DISPID_SRCCreateGrammar', 'SpeechStreamFileMode',
    'DISPID_SRCVoice', 'DISPID_SVStatus',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPAS_CLOSED', 'SPSVerb',
    'DISPID_SRCAudioInInterferenceStatus', 'SpeechTokenIdUserLexicon',
    'ISpeechPhraseInfo', 'SP_VISEME_13', 'DISPID_SOTCId',
    'SPPHRASEPROPERTY', 'ISpeechGrammarRuleState',
    'SWPKnownWordPronounceable', 'LONG_PTR',
    'DISPID_SpeechRecoResult2', 'ISpeechBaseStream',
    'DISPID_SRRTimes', 'DISPID_SPANumberOfElementsInResult',
    'SREPhraseStart', 'DISPID_SPERequiredConfidence',
    'SPEI_UNDEFINED', 'DISPID_SPIRule', 'ISpDataKey',
    'DISPID_SGRSTPropertyValue', 'SPEI_SR_PRIVATE', 'SPCT_DICTATION',
    'SpeechGrammarTagDictation', 'SAFT22kHz16BitStereo',
    'SpPhraseInfoBuilder', 'DISPID_SWFEAvgBytesPerSec',
    'SPWF_SRENGINE', 'SPEI_MAX_TTS', 'SpeechTokenKeyFiles', 'SPRULE',
    'SPGS_DISABLED', 'SPEVENTENUM', 'SpShortcut', 'ISpEventSink',
    'SVP_9', 'SPEI_FALSE_RECOGNITION', 'SPPS_LMA',
    'SpPhoneticAlphabetConverter', 'SpeechRecognitionType',
    'DISPID_SpeechGrammarRuleState', 'SVP_5', 'ISpeechGrammarRule',
    'SVEViseme', 'ISpNotifySink', 'SPSFunction', 'DISPID_SPAsItem',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SMSAMMHandle',
    'SPEI_END_SR_STREAM', 'SPWT_DISPLAY', 'ISpStream',
    'SDTDisplayText', 'DISPID_SWFEBitsPerSample', 'DISPID_SVSpeak',
    'ISpeechPhraseAlternate', 'DISPID_SDKOpenKey',
    'SPFM_OPEN_READWRITE', 'SAFTCCITT_ALaw_8kHzMono', 'SP_VISEME_11',
    'SPAS_RUN', 'SECFNoSpecialChars', 'SPVPRI_ALERT', 'SPCS_ENABLED',
    'DISPID_SRGRules', 'DISPID_SPPEngineConfidence', 'SRESoundStart',
    'DISPID_SRGCmdLoadFromFile', 'SDA_Two_Trailing_Spaces',
    'Speech_Max_Pron_Length', 'ISpeechXMLRecoResult',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SPARecoResult',
    'DISPID_SGRSTsCount', 'SREPropertyStringChange', 'SPAR_Medium',
    'DISPID_SVSInputSentencePosition', 'SPINTERFERENCE',
    'SP_VISEME_17', 'ISpVoice', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SABIMinNotification',
    'SAFTExtendedAudioFormat', 'DISPID_SOTCategory', 'SGLexical',
    'SINoise', 'ISpeechRecoContext', 'ISpRecognizer3',
    'SDA_Consume_Leading_Spaces', 'SRARoot',
    'SGDSActiveUserDelimited', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SLPLangId', 'SpObjectToken', 'SPXRO_Alternates_SML',
    'SpVoice', 'SAFT8kHz8BitStereo', 'SAFT22kHz8BitMono',
    'SVSFNLPSpeakPunc', 'SPSMF_UPS', 'DISPID_SDKGetBinaryValue',
    'SRTReSent', 'Speech_Default_Weight', 'SPDKL_LocalMachine',
    'SpInProcRecoContext', 'SPEI_RESERVED3', 'STCInprocHandler',
    'SPEI_SOUND_START', 'DISPID_SFSOpen', 'ISpRecognizer',
    'DISPID_SBSSeek', 'DISPID_SPRNumberOfElements', 'SPPS_Unknown',
    'eLEXTYPE_PRIVATE17', 'DISPID_SpeechLexiconWords',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SLPPartOfSpeech',
    'DISPID_SVGetProfiles', 'SVEVoiceChange', 'STCRemoteServer',
    'SRERequestUI', 'SP_VISEME_15', 'DISPID_SLWsCount', 'SASClosed',
    'SAFT24kHz16BitStereo', 'SAFT12kHz8BitStereo', 'SLOStatic',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SAFSetWaveFormatEx',
    'SVEPhoneme', 'SRAONone', 'ISpeechPhraseRule', 'DISPID_SPRuleId',
    'eLEXTYPE_PRIVATE15', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SGRSRule', 'DISPID_SPERetainedSizeBytes',
    'SpeechAudioFormatGUIDText', 'ISpeechLexiconWords',
    'DISPID_SPEAudioTimeOffset', 'SPSMF_SRGS_SAPIPROPERTIES',
    'ISpRecoCategory', 'SRTExtendableParse',
    'DISPID_SpeechRecoResult', 'DISPID_SASCurrentDevicePosition',
    'ISpeechPhraseRules', 'SPCATEGORYTYPE', '_SPAUDIOSTATE',
    'ISpRecognizer2', 'ISpeechPhraseElements', 'SPPS_RESERVED3',
    '__MIDL_IWinTypes_0009', 'DISPIDSPTSI_ActiveOffset',
    'SDKLCurrentConfig', 'SP_VISEME_6', 'SREHypothesis',
    'SAFTGSM610_8kHzMono', 'DISPID_SGRsDynamic',
    'DISPID_SpeechPhraseRules', 'SpeechAudioState',
    'DISPID_SRCRetainedAudio', 'SpeechAudioProperties',
    'SpeechPropertyResourceUsage', 'SPEI_SENTENCE_BOUNDARY',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SASetState',
    'SAFTCCITT_uLaw_8kHzMono', 'eLEXTYPE_PRIVATE6', 'SDTReplacement',
    'SPFM_CREATE_ALWAYS', 'SRTAutopause', 'DISPID_SVResume',
    'SPEI_MAX_SR', 'DISPID_SpeechObjectTokens',
    'DISPID_SRSAudioStatus', 'IEnumString', 'DISPID_SCSBaseStream',
    'DISPID_SRGetPropertyString', 'DISPID_SPPId', 'SAFT44kHz8BitMono',
    'SPXMLRESULTOPTIONS', 'SP_VISEME_18',
    'DISPID_SpeechRecoResultTimes', 'ISpRecoGrammar',
    'DISPID_SPEDisplayText', 'DISPID_SABIEventBias',
    'SPSInterjection', 'DISPID_SPIAudioSizeBytes', 'SVSFUnusedFlags',
    'DISPID_SpeechRecognizerStatus', 'STCAll',
    'ISpeechPhraseInfoBuilder',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPRECOGNIZERSTATUS',
    'SPRS_ACTIVE', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SpeechPropertyHighConfidenceThreshold', 'Speech_Max_Word_Length',
    'DISPID_SVIsUISupported', '_RemotableHandle',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SRRAudio',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SpeechEmulationCompareFlags',
    'STCInprocServer', 'SSTTTextBuffer', 'DISPID_SRGCmdSetRuleState',
    'SREAdaptation', 'eLEXTYPE_RESERVED9',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SDKGetStringValue',
    'ISpeechRecoResultTimes', 'SpeechSpecialTransitionType',
    'SPWT_PRONUNCIATION', 'SpUnCompressedLexicon', 'SPLOADOPTIONS',
    'eLEXTYPE_PRIVATE18', 'SPAUDIOSTATUS', 'SRERecognition',
    'SpeechRecoEvents', 'SPWORDPRONOUNCEABLE', 'DISPID_SRRPhraseInfo',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'eLEXTYPE_RESERVED6',
    'SRCS_Enabled', 'eLEXTYPE_USER_SHORTCUT', 'SpMMAudioEnum',
    'DISPID_SLWPronunciations', 'DISPID_SPIEnginePrivateData',
    'SECFIgnoreKanaType', 'SRSActiveAlways', 'SPEI_VISEME',
    'eLEXTYPE_PRIVATE1', 'DISPID_SpeechMemoryStream', 'ISpeechAudio',
    'SAFT16kHz8BitMono', 'SP_VISEME_2', 'SGSDisabled', 'UINT_PTR',
    'DISPID_SRGReset', 'SAFTADPCM_22kHzStereo', 'SPCT_SUB_COMMAND',
    'DISPID_SPIGrammarId', 'SPLO_DYNAMIC', 'DISPID_SGRsCommitAndSave',
    'SpStream', 'DISPID_SPIProperties', 'eLEXTYPE_PRIVATE13',
    'IEnumSpObjectTokens', 'ISpObjectTokenCategory', 'SVSFParseSapi',
    'DISPID_SRProfile', 'DISPID_SRSetPropertyString',
    'ISpeechDataKey', 'SVP_16', 'DISPID_SPEPronunciation',
    'SpSharedRecognizer', 'SVSFIsFilename',
    'SpeechDictationTopicSpelling', 'SGDisplay', 'SPVPRIORITY',
    'DISPID_SRCEPropertyStringChange', 'SREAudioLevel',
    'DISPID_SPERetainedStreamOffset', 'SVP_2', 'SPGS_ENABLED',
    'DISPID_SLWsItem', 'DISPID_SPAStartElementInResult',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRCERequestUI',
    'DISPID_SRGetFormat', 'SLTApp', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPEI_RESERVED5',
    'DISPID_SPRuleParent', 'DISPID_SLPPhoneIds',
    'SpeechTokenKeyAttributes', 'DISPID_SVEEnginePrivate', 'SPWORD',
    'DISPID_SGRSAddWordTransition', 'SAFT24kHz16BitMono',
    'SPPS_SuppressWord', 'Speech_StreamPos_Asap',
    'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SDKLLocalMachine', 'ISpMMSysAudio', 'SVP_19',
    'ISpeechObjectTokens', 'SVEEndInputStream', 'eLEXTYPE_PRIVATE19',
    'DISPID_SOTs_NewEnum', 'STSF_CommonAppData',
    'DISPID_SVSpeakStream', 'SAFT48kHz16BitStereo',
    'DISPID_SPCLangId', 'DISPID_SVGetVoices', 'STSF_AppData',
    'DISPID_SGRInitialState', 'SWTAdded', 'SPINTERFERENCE_NOSIGNAL',
    'SPEI_RECO_OTHER_CONTEXT', 'SVEStartInputStream',
    'SPRECORESULTTIMES', 'DISPID_SPEEngineConfidence',
    'SpStreamFormatConverter', 'SINoSignal', 'SPSHORTCUTPAIRLIST',
    'SPPS_Modifier', 'DISPID_SRCBookmark', 'DISPID_SpeechVoiceEvent',
    'SpeechVoiceEvents', 'SP_VISEME_4', 'DISPID_SPRFirstElement',
    'DISPID_SMSALineId', 'DISPID_SPRulesItem',
    'DISPID_SPIAudioSizeTime', 'ISpeechVoiceStatus', 'SPVPRI_OVER',
    'SP_VISEME_7', 'SDKLDefaultLocation', 'DISPID_SGRAddState',
    'SLTUser', 'DISPID_SDKDeleteKey', 'DISPID_SpeechBaseStream',
    'ISpeechGrammarRuleStateTransition', 'SPWORDTYPE',
    'SECFIgnoreCase', 'DISPID_SVESentenceBoundary',
    'SAFTCCITT_uLaw_44kHzStereo', 'WAVEFORMATEX', 'SAFT8kHz8BitMono',
    '_ISpeechRecoContextEvents', 'eLEXTYPE_PRIVATE7', 'SVP_1',
    'SPEVENT', 'SPFM_NUM_MODES', 'SpeechInterference', 'SSFMCreate',
    'SRSEIsSpeaking', 'eLEXTYPE_PRIVATE11', 'SPEI_START_SR_STREAM',
    'SVSFPurgeBeforeSpeak', 'SPSNotOverriden', 'SpCompressedLexicon',
    'SpeechCategoryRecognizers', 'DISPID_SPEsItem',
    'DISPID_SOTGetStorageFileName', 'SAFT16kHz16BitMono',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechMemoryStream',
    'ISpPhoneConverter', 'SAFTGSM610_11kHzMono', 'SVP_18',
    'SPSUnknown', 'eLEXTYPE_RESERVED7', 'SPEI_PHRASE_START',
    'SpeechPropertyNormalConfidenceThreshold', 'SVSFNLPMask',
    'DISPID_SPAPhraseInfo', 'SDTPronunciation',
    'SpeechVoiceSkipTypeSentence', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SRGetRecognizers', 'SPEI_MIN_TTS',
    'ISpeechPhraseReplacements', 'SVP_7', 'ISpSerializeState',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SLPsItem', 'ISpNotifyTranslator',
    'eLEXTYPE_PRIVATE14', 'SPPS_Noncontent', 'ISpeechLexiconWord',
    'SPVOICESTATUS', 'SAFTCCITT_uLaw_44kHzMono',
    'SPEI_END_INPUT_STREAM', 'SPEI_SOUND_END',
    'Speech_StreamPos_RealTime', 'SPRST_INACTIVE',
    'DISPID_SRRTOffsetFromStart', 'SPINTERFERENCE_LATENCY_WARNING',
    'SVP_10', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SPEs_NewEnum', 'SPWORDLIST', 'ISequentialStream',
    'SPFM_OPEN_READONLY', 'SAFT32kHz16BitStereo', 'eLEXTYPE_PRIVATE5',
    'DISPID_SPRuleNumberOfElements', 'SVEPrivate',
    'DISPID_SRCRequestedUIType', 'SAFT32kHz8BitStereo',
    'SDKLCurrentUser', 'SPBO_NONE', 'SDTAlternates',
    'SPSERIALIZEDRESULT', 'DISPID_SpeechLexiconProns', 'SREStreamEnd',
    'DISPID_SFSClose', 'DISPID_SGRAddResource', 'ISpeechVoice',
    'SPEI_TTS_PRIVATE', 'SPEI_INTERFERENCE', 'SGRSTTRule',
    'DISPID_SPISaveToMemory', 'DISPID_SpeechFileStream',
    'ISpPhoneticAlphabetSelection', 'SITooSlow', 'SPLEXICONTYPE',
    'SpNotifyTranslator', 'DISPID_SPPsCount',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SAStatus', 'SpResourceManager', 'DISPID_SpeechPhraseRule',
    'SPFM_CREATE', 'ISpRecoContext2', 'ISpeechPhraseAlternates',
    'SP_VISEME_8', 'SPEI_RECO_STATE_CHANGE',
    'SpeechPropertyLowConfidenceThreshold', 'ISpeechPhraseElement',
    'DISPID_SRGDictationUnload', 'SPAR_Low', 'SP_VISEME_3',
    'SREAllEvents', 'DISPID_SRAudioInputStream',
    'SAFT8kHz16BitStereo', 'SAFTADPCM_22kHzMono',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SRGCmdLoadFromMemory',
    'SRAExport', 'ISpObjectToken', 'ISpAudio', 'DISPID_SRRAlternates',
    'SGSExclusive', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SRGCmdLoadFromResource', 'SPDKL_DefaultLocation',
    'SPPHRASE', 'SPWF_INPUT', 'DISPID_SABufferNotifySize',
    'SECHighConfidence', 'SRCS_Disabled', 'DISPID_SRRRecoContext',
    'SVF_None', 'SpeechGrammarTagWildcard', 'DISPID_SRCESoundStart',
    'eLEXTYPE_RESERVED4', 'DISPID_SVAudioOutput', 'SpeechRuleState',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SGRSTPropertyId',
    'DISPID_SVSInputSentenceLength', 'SPRS_INACTIVE', 'SVEAllEvents',
    'DISPID_SPRulesCount', 'DISPID_SGRsAdd',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SRCEInterference',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SPIGetText', 'SPINTERFERENCE_NONE',
    'DISPID_SPPValue', 'SP_VISEME_10', 'IInternetSecurityMgrSite',
    'ISpeechGrammarRules', 'DISPID_SPACommit',
    'ISpeechRecognizerStatus', 'DISPID_SpeechLexicon', 'SBONone',
    'DISPID_SPPs_NewEnum', 'ISpLexicon',
    'SpeechPropertyComplexResponseSpeed', 'SDTLexicalForm',
    'ISpRecoResult', 'DISPID_SLRemovePronunciation',
    'DISPID_SRCSetAdaptationData', 'DISPID_SRCEPhraseStart',
    'ISpStreamFormatConverter', 'DISPID_SPEActualConfidence',
    'eWORDTYPE_DELETED', 'DISPID_SRCEStartStream', 'SRSActive',
    'SDTAudio', 'SpeechVoiceCategoryTTSRate', 'SAFTADPCM_8kHzMono',
    'SVP_20', 'DISPIDSPRG', 'SVSFParseAutodetect',
    'DISPID_SpeechAudioFormat', 'SRAImport', 'SAFT22kHz16BitMono',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SRCEPropertyNumberChange',
    'SVP_15', 'DISPID_SVRate', 'SPSHT_EMAIL', 'ISpShortcut',
    'DISPID_SRCEAdaptation', 'SPEI_ADAPTATION', 'SVP_4',
    'DISPID_SVEPhoneme', 'SSFMOpenReadWrite', 'SpeechCategoryAudioIn',
    'DISPID_SPEDisplayAttributes', 'SpeechAddRemoveWord',
    'DISPID_SREmulateRecognition', 'DISPID_SpeechPhraseBuilder',
    'SpeechVisemeFeature', 'SAFTCCITT_uLaw_8kHzStereo',
    'ISpNotifySource', 'DISPID_SVGetAudioInputs',
    'DISPID_SLWs_NewEnum', 'ISpeechWaveFormatEx', 'SPAO_RETAIN_AUDIO',
    'SPCT_SUB_DICTATION', 'DISPID_SRRTStreamTime', 'DISPID_SVVoice',
    'DISPID_SGRSTWeight', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SPEAudioStreamOffset', 'SPSEMANTICFORMAT',
    'DISPID_SAEventHandle', 'SREStreamStart', 'SPVISEMES',
    'SPPS_Verb', 'SAFTCCITT_uLaw_11kHzStereo', 'SPBINARYGRAMMAR',
    'SWPUnknownWordPronounceable', 'DISPID_SRGState',
    'DISPID_SpeechVoiceStatus', 'SDA_One_Trailing_Space',
    'SpeechTokenKeyUI', 'SPEI_RECOGNITION', 'DISPID_SVSLastBookmark',
    'SpeechLoadOption', 'DISPID_SGRClear', 'DISPID_SRGCommit',
    'DISPID_SLGenerationId', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SVSInputWordLength', 'DISPID_SBSFormat', 'SPPHRASERULE',
    'eLEXTYPE_RESERVED8', 'DISPID_SOTCGetDataKey', 'DISPID_SPRsItem',
    'SAFT11kHz16BitStereo', 'DISPID_SpeechPhraseProperty', 'SVP_13',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SGRSTsItem', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SOTRemove', 'SGDSActiveWithAutoPause',
    'SAFT32kHz8BitMono', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SpeechWaveFormatEx', 'SREPropertyNumChange',
    'eLEXTYPE_PRIVATE10', '_ISpeechVoiceEvents',
    'DISPID_SWFESamplesPerSec', 'SpeechPropertyResponseSpeed',
    'eLEXTYPE_PRIVATE2', 'SLODynamic',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SVSFDefault',
    'SVP_12', 'SAFTNoAssignedFormat', 'DISPID_SVVolume',
    'SAFTCCITT_ALaw_44kHzMono', 'SDTAll', 'DISPID_SVEViseme',
    'DISPID_SVEBookmark', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPEI_VOICE_CHANGE', 'DISPID_SOTMatchesAttributes',
    'DISPID_SWFEBlockAlign', 'DISPID_SBSWrite', 'DISPID_SGRSTText',
    'SVSFIsNotXML', 'SPGRAMMARWORDTYPE', 'eLEXTYPE_LETTERTOSOUND',
    'ISpeechRecoResult', 'SpeechRecoProfileProperties',
    'ISpeechPhraseReplacement', 'DISPID_SLPType', 'DISPID_SPAsCount',
    'DISPID_SpeechRecoContext', 'SAFT44kHz8BitStereo',
    'SPEVENTSOURCEINFO', 'SpeechPartOfSpeech',
    'DISPID_SRGDictationSetState', 'SPINTERFERENCE_NOISE',
    'STSF_FlagCreate', 'DISPID_SRCEHypothesis',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SRRGetXMLErrorInfo',
    'ISpeechObjectTokenCategory', 'SAFT11kHz16BitMono',
    'SPEI_RESERVED1', 'ISpObjectWithToken', 'SRTStandard',
    'ISpeechAudioStatus', 'SPPS_Noun', 'DISPID_SVSPhonemeId',
    'SVSFParseMask', 'SPRECOCONTEXTSTATUS', 'eLEXTYPE_PRIVATE3',
    'SVP_3', 'eLEXTYPE_PRIVATE4', 'SpeechDisplayAttributes', 'SVP_21',
    'DISPID_SRRTLength', 'SVPAlert',
    'ISpeechTextSelectionInformation', 'SpeechLexiconType',
    'SRTSMLTimeout', 'DISPID_SRCERecognition', 'SDTProperty',
    'IInternetSecurityManager', 'SWPUnknownWordUnpronounceable',
    'SpeechTokenValueCLSID', 'SVSFVoiceMask', 'SVF_Emphasis',
    'SPVPRI_NORMAL', 'DISPID_SADefaultFormat', 'DISPID_SAFType',
    'SPPS_Interjection', 'DISPID_SGRSTType', 'SAFTDefault',
    'DISPID_SOTsItem', 'SGRSTTWildcard', 'SAFT11kHz8BitStereo',
    'SPBO_AHEAD', 'SECFIgnoreWidth', 'DISPID_SPIGetDisplayAttributes',
    'SSTTDictation', 'DISPID_SVEVoiceChange', 'SAFT24kHz8BitStereo',
    'SPAUDIOSTATE', 'DISPID_SpeechMMSysAudio', 'DISPID_SMSSetData',
    'DISPID_SGRSTPropertyName', 'SPWAVEFORMATTYPE', 'SpCustomStream',
    'SGRSTTTextBuffer', 'ISpeechPhoneConverter',
    'ISpeechRecoResultDispatch', 'SVF_Stressed',
    'SpeechBookmarkOptions', 'DISPID_SLGetWords',
    'DISPID_SOTDisplayUI', 'SpeechAllElements', 'SVP_8',
    'SECFEmulateResult', 'SpeechRetainedAudioOptions',
    'DISPID_SPRDisplayAttributes', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SPRs_NewEnum', 'DISPID_SPIAudioStreamPosition', 'SVP_17',
    'SpLexicon', 'SVESentenceBoundary', 'SpPhoneConverter',
    'DISPID_SRGIsPronounceable', 'SVEAudioLevel',
    'DISPID_SPELexicalForm', 'SGSEnabled', 'SAFTGSM610_22kHzMono',
    'SPEI_TTS_BOOKMARK', 'SPCT_SLEEP', 'SpeechCategoryVoices',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SDKDeleteValue',
    'SSFMCreateForWrite', 'SRSInactive', 'SpMemoryStream',
    'DISPID_SOTDataKey', 'DISPID_SVSInputWordPosition',
    'DISPID_SLWLangId', 'SpeechVoiceSpeakFlags', 'SVPOver',
    'SpObjectTokenCategory', 'SPPS_Function', 'DISPID_SGRsItem',
    'SRERecoOtherContext', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SpeechAudio', 'SPSHT_Unknown', 'SPLO_STATIC',
    'SRADynamic', 'DISPID_SRState', 'DISPID_SRRDiscardResultInfo',
    'SAFTCCITT_ALaw_22kHzMono', 'SpeechDiscardType',
    'SPBOOKMARKOPTIONS', 'SPAR_High', 'SWTDeleted',
    'SAFT16kHz16BitStereo', 'DISPID_SPPsItem', 'DISPID_SGRs_NewEnum',
    'DISPID_SPIEngineId', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SASNonBlockingIO',
    'ISpPhoneticAlphabetConverter',
    'SpeechGrammarTagUnlimitedDictation', 'SpeechEngineConfidence',
    'DISPID_SVEAudioLevel', 'SECLowConfidence', 'DISPID_SPCPhoneToId',
    'DISPID_SVSRunningState', 'eLEXTYPE_PRIVATE12',
    'SAFTCCITT_uLaw_22kHzMono', 'SDTRule', 'SPAUDIOOPTIONS',
    'DISPID_SpeechAudioStatus', 'DISPID_SABufferInfo',
    'SPDKL_CurrentUser', 'SP_VISEME_1', 'DISPID_SRCEEnginePrivate',
    'DISPID_SPEsCount', 'SAFTText', 'DISPID_SWFEChannels',
    'ISpeechRecoGrammar', 'DISPID_SPRuleConfidence',
    'DISPID_SPPChildren', 'DISPID_SPEAudioSizeTime', 'eLEXTYPE_APP',
    'tagSPPROPERTYINFO', 'SPBO_TIME_UNITS', 'DISPID_SPPParent',
    'SpNullPhoneConverter', 'SpeechVoicePriority', 'SPEI_RESERVED2',
    'DISPID_SLWType', 'eLEXTYPE_MORPHOLOGY', 'SPBO_PAUSE',
    'SAFT8kHz16BitMono', 'SPDATAKEYLOCATION', 'SVP_6',
    'SPSEMANTICERRORINFO', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SpeechRecognizer', 'SRSInactiveWithPurge',
    'DISPID_SOTCreateInstance', 'DISPID_SRSClsidEngine',
    'SPDKL_CurrentConfig', 'DISPID_SPAs_NewEnum',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SVPause',
    'DISPID_SDKEnumValues', 'SpSharedRecoContext',
    'DISPID_SWFEFormatTag', 'DISPIDSPTSI', 'SPPS_RESERVED1',
    'ISpeechRecognizer', 'eLEXTYPE_RESERVED10', 'ISpPhrase',
    'DISPID_SRRecognizer', 'DISPID_SRStatus',
    'DISPID_SVSLastBookmarkId', 'SPEI_HYPOTHESIS', 'SPPARTOFSPEECH',
    'SPPS_NotOverriden', 'DISPID_SRRSetTextFeedback',
    'SRADefaultToActive', 'SPPS_RESERVED2', 'DISPID_SRRAudioFormat',
    'DISPID_SRGId', 'SAFT16kHz8BitStereo', 'SPWORDPRONUNCIATION',
    'SpeechVisemeType', 'DISPID_SDKSetLongValue',
    'SAFT12kHz16BitMono', 'DISPID_SVEventInterests',
    'DISPID_SpeechObjectToken', 'SPCONTEXTSTATE',
    'DISPID_SVSLastStreamNumberQueued', 'SPADAPTATIONRELEVANCE',
    'DISPID_SOTCDefault', 'SpeechEngineProperties', 'DISPID_SPPName',
    'SPAS_STOP', 'SASPause', 'ISpeechAudioFormat',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eWORDTYPE_ADDED', 'SPSLMA'
]
